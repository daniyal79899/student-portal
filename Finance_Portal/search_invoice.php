...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" style="background-color:#73D7FF !important;">
        <a class="navbar-brand" style="font-size:24px; color: white" href="#">Payment Portal</a>
    ...
    <h2 style="font-size:28px; font-weight:bold">Find Invoice</h2>
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            ...
            <button type="submit" class="btn btn-success">Find Invoice</button>
        </form>
