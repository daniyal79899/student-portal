...
<body>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top " style="background-color:#73D7FF;">
        <a class="navbar-brand" href="dashboard.php?std_id=<?php echo $_GET['std_id']; ?>" style="font-size:24px; color: white">Student Portal</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" style="font-size:18px; color: white" href="student_profile.php?student_id=<?php echo $_GET['std_id']; ?>">View/Update Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="font-size:18px; color: white" href="graduation.php?std_id=<?php echo $_GET['std_id']; ?>">Graduation</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" style="font-size:18px; color: white" href="index.php">Logout</a>
                </li>
            </ul>
        </div>
    </nav>
